...
if (NotionCard_notionContent) {
  ...
  if (NotionCard_parentElement) {
    NotionCard_parentElement.style.padding = '50px';
    NotionCard_parentElement.style.backgroundImage = 'linear-gradient(100deg, rgb(204, 251, 252), rgb(197, 234, 254), rgb(189, 211, 255))';
  } else {
